...
public class ContactController {
    ...
    @PostMapping("/contact")
    public ResponseEntity<?> postContactForm(@Valid @RequestBody ContactFormMessage contactFormMessage) {
        emailService.sendSimpleMessage(
                "siphydrated@gmail.com",
                "Kontaktformular: " + contactFormMessage.getSubject(),
                "Von: " + contactFormMessage.getName() + ", " + contactFormMessage.getEmail() + "\n" +
